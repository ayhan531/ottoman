...
const SHAPES = {
  ...
  share: () => [
    ...
    <path key="b" d={L(8.4, 6.4, 12, 2.8, 15.6, 6.4)} />,
    <path key="c" d="M7.5 9.5H6A2 2 0 0 0 4 11.5V19A2 2 0 0 0 6 21H18A2 2 0 0 0 20 19V11.5A2 2 0 0 0 18 9.5H16.5" />,
  ],
  // Ana ekrana ekle: içinde artı olan kutu.
  addhome: () => [R(3.5, 3.5, 17, 17, 4, "a"), <path key="b" d={L(12, 8, 12, 16)} />, <path key="c" d={L(8, 12, 16, 12)} />],
